...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('projectApp', '0002_author_delete_member'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(null=True, on_delete=django.db.models.deletion.RESTRICT, to='projectApp.author')),
                ('genre', models.ManyToManyField(help_text='Select a genre for this book', to='projectApp.genre')),
            ],
        ),
        migrations.CreateModel(
            name='BookInstance',
