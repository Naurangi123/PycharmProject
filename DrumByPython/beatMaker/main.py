...
def draw_grid(clicks, beat, actives):
    ...
    for i in range(instruments + 1):
        pygame.draw.line(screen, gray, (0, i * 80), (200, i * 80), 3)
    ...
    for i in range(beats):
        for j in range(instruments):
            ...
            rect = pygame.draw.rect(screen, color,
                                    [i * ((WIDTH - 200) // beats) + 205, (j * 80) + 5, ((WIDTH - 200) // beats) - 10,
                                     70], 0, 3)
            pygame.draw.rect(screen, gold, [i * ((WIDTH- 200) // beats) + 200, j * 80, ((WIDTH - 200) // beats), 80],
                             5, 5)
            pygame.draw.rect(screen, black,
                             [i * ((WIDTH - 200) // beats) + 200, j * 80, ((WIDTH - 200) // beats), 80],
                             2, 5)
...
while run:
    ...
    BOX_WIDTH = 140
    BOX_HEIGHT = 70
    play_pause = pygame.draw.rect(screen, gray, [50, HEIGHT - 130, BOX_WIDTH, BOX_HEIGHT], 0, 5)
    play_text = label_font.render('Play/Pause', True, white)
    screen.blit(play_text, (50, HEIGHT - 120))
    if playing:
    ...
    # Adjusted positions for BPM buttons
    bpm_rect = pygame.draw.rect(screen, gray, [300, HEIGHT - 130, BOX_WIDTH, BOX_HEIGHT], 5, 5)
    bpm_text = medium_font.render('Beats Per Minute', True, white)
    screen.blit(bpm_text, (308, HEIGHT - 120))
    bpm_text2 = label_font.render(f'{bpm}', True, white)
    screen.blit(bpm_text2, (370, HEIGHT - 90))
    bpm_add_rect = pygame.draw.rect(screen, gray, [510, HEIGHT - 130, 40, 40], 0, 5)
    bpm_sub_rect = pygame.draw.rect(screen, gray, [510, HEIGHT - 90, 40, 40], 0, 5)
    add_text = medium_font.render('+5', True, white)
    screen.blit(add_text, (520, HEIGHT - 120))
    sub_text = medium_font.render('-5', True, white)
    screen.blit(sub_text, (520, HEIGHT - 80))

    # Adjusted positions for beats per loop buttons
    beats_rect = pygame.draw.rect(screen, gray, [600, HEIGHT - 130, BOX_WIDTH, BOX_HEIGHT], 5, 5)
    beats_text = medium_font.render('Beats In Loop', True, white)
    screen.blit(beats_text, (612, HEIGHT - 120))
    beats_text2 = label_font.render(f'{beats}', True, white)
    screen.blit(beats_text2, (670, HEIGHT - 90))
    beats_add_rect = pygame.draw.rect(screen, gray, [810, HEIGHT - 130, 40, 40], 0, 5)
    beats_sub_rect = pygame.draw.rect(screen, gray, [810, HEIGHT - 90, 40, 40], 0, 5)
    add_text2 = medium_font.render('+1', True, white)
    screen.blit(add_text2, (820, HEIGHT - 120))
    sub_text2 = medium_font.render('-1', True, white)
    screen.blit(sub_text2, (820, HEIGHT - 80))

    # Adjusted position for clear board button
    clear = pygame.draw.rect(screen, gray, [1080, HEIGHT - 90, BOX_WIDTH, BOX_HEIGHT], 0, 5)
    play_text = label_font.render('Clear Board', True, white)
    screen.blit(play_text, (1080, HEIGHT - 90))

    # Adjusted positions for save and load buttons
    save_button = pygame.draw.rect(screen, gray, [900, HEIGHT - 130, BOX_WIDTH, 40], 0, 5)
    save_text = label_font.render('Save Beat', True, white)
    screen.blit(save_text, (920, HEIGHT - 120))
    load_button = pygame.draw.rect(screen, gray, [900, HEIGHT - 90, BOX_WIDTH, 40], 0, 5)
    load_text = label_font.render('Load Beat', True, white)
    screen.blit(load_text, (920, HEIGHT - 80))
